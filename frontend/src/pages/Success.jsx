  ...
  return (
    <main className="success-page">
      <section className="success-panel">
        ...
        <p>O Studio Cut recebeu seu agendamento e poderá confirmar o status pelo painel.</p>
        ...
        <button className="primary-button" onClick={onBack}>Voltar para a home</button>
      </section>
    </main>
  );
}
